/**
 * Shared types and helpers for Distac API stress tests.
 */
...
export function loadConfig(overrides: Partial<StressConfig> = {}): StressConfig {
  return {
    ...
    email: process.env.STRESS_EMAIL ?? 'admin@distac.com.br',
...
/**
 * Authenticates against Distac and returns Cookie header for subsequent calls.
