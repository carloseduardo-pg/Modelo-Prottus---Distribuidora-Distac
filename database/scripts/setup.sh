#!/usr/bin/env bash
# Cria role/database Distac se precisar — sem pedir senha.
# Se postgree@distac já existir, apenas confirma e sai OK.
set -euo pipefail
...
# Caso feliz: já dá para usar o banco Distac
