# Documentação do projeto — Distac

Fonte da verdade do **produto Distac** e da **base web Prottus** deste repo.

Metodologia empresa (somente leitura): [`../prottus/`](../prottus/).  
Como reutilizar o repo: [`USAR-COMO-BASE.md`](USAR-COMO-BASE.md).
